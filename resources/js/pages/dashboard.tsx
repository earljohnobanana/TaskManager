                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <Card className="border-blue-500/20 bg-gradient-to-br from-blue-500/10 to-blue-600/10">
                        ...
                        <CardContent>
                            ...
                            <p className="text-muted-foreground text-xs">All your Lists</p>{' '}
                        </CardContent>{' '}
                    </Card>
                    ...
                    <Card className="border-yellow-500/20 bg-gradient-to-br from-yellow-500/10 to-yellow-600/10">
                        ...
                        <CardContent>
                            ...
                            <p className="text-muted-foreground text-xs">Tasks to be completed </p>
                        </CardContent>{' '}
                    </Card>
                    <Card className="border-purple-500/20 bg-gradient-to-br from-purple-500/10 to-purple-600/10">
                        ...
                        <CardContent>
                            ...
                            <p className="text-muted-foreground text-xs">Task that are completed </p>
                        </CardContent>{' '}
                    </Card>{' '}
                </div>
